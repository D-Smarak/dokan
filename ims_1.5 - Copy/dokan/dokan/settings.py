...
SECRET_KEY = 'django-insecure-&=-aox$tcd(y1+c@(jmgb)w(fl&qa5e5uf%4*14me=%d%59d0q'
...
INSTALLED_APPS = [
    ...
    # local
    'extras.apps.StoreConfig',
    'partners.apps.UsersConfig',
    'sales.apps.StoreConfig',
    'warehouse.apps.UsersConfig',
...
TEMPLATE_DIRS = [
    os.path.join(BASE_DIR, 'templates'),  # Common templates for the entire project
